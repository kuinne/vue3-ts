...
export type MapOptions<T extends ChildrenKey> = BaseOptions<T>;

export type MapCallbackMeta<T extends ChildrenKey> = BaseCallbackMeta<T>;

export type MapCallback<T extends ChildrenKey> = (
  treeItem: Tree<T>,
  meta: MapCallbackMeta<T>
) => any;
...
type MapImpl<T extends ChildrenKey> = (
  treeItem: Tree<T>,
  callback: MapCallback<T>,
  options: MapInnerOption<T>
) => Tree<T>;
...
export type MapForTree<T extends ChildrenKey> = (
  tree: Tree<T>,
  callback: MapCallback<T>,
  options?: MapOptions<T>
) => Tree<T>;
export type MapForForest<T extends ChildrenKey> = (
  tree: Tree<T>,
  callback: MapCallback<T>,
  options?: MapOptions<T>
) => Tree<T>[];

function map<T extends ChildrenKey>(
  tree: Tree<T>,
  callback: MapCallback<T>,
  options?: MapOptions<T>
): Tree<T>;
